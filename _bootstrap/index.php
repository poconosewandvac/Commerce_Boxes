...
if (!createObject('modNamespace',array(
    'name' => 'commerce_boxes',
    'path' => $componentPath.'/core/components/commerce_boxes/',
    'assets_path' => $componentPath.'/assets/components/commerce_boxes/',
),'name', false)) {
    echo "Error creating namespace commerce_boxes.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_boxes.core_path',
    'value' => $componentPath.'/core/components/commerce_boxes/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_boxes',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_boxes.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_boxes.assets_path',
    'value' => $componentPath.'/assets/components/commerce_boxes/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_boxes',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_boxes.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_boxes/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_boxes.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_boxes',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_boxes.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        ...
        echo "Error creating commerce_boxes.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_boxes/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_boxes/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'PoconoSewVac\\Boxes\\Modules\\', $modulePath);
$manager = $modx->getManager();
$modx->addPackage('commerce_boxes', $componentPath . '/core/components/commerce_boxes/model/');
$manager->createObjectContainer('Boxes');
